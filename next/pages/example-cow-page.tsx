...
import {IPagesTestCmstestFields} from '../lib/types/generated/contentful'

export default function CMSTest({data}: {data: IPagesTestCmstestFields}) {
	return (
		<Container>
...
export const getStaticProps: GetStaticProps = async (context) => {
	...
	const fieldData = pageData.fields as IPagesTestCmstestFields

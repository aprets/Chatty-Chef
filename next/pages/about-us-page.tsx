...
export default function AboutUsPage() {
	return (
		<>
			...
			<Text mt={10} sx={{fontSize: 20, fontWeight: 200}} align='center'>
				We are a team of experienced chefs who are passionate about good food and dedicated to showcasing the products of local artisans and producers from the community.
				When we opened the restaurant almost two years ago, we knew that we would draw on our individual backgrounds to make it a unique dining experience, and each of us brings with him/her a unique perspective and passion.
			</Text>
			<Text mt={10} sx={{fontSize: 20, fontWeight: 200}} align='center'>
				Chris attended the Culinary Institute of America, after which he spent eight years working in various NYC restaurants, including Brasserie 8 ½ and Kiki on the Seine.
			...
			<Text mt={10} sx={{fontSize: 20, fontWeight: 200}} align='center'>
				...
				Since opening, the team has strived to serve a menu that is simple yet sophisticated, with fresh, local ingredients, and share some fun stories about our local community and area
			</Text>
